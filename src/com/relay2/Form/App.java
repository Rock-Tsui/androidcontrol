...
public class App {
    ...
    private static ImageIcon icon = new ImageIcon(App.class.getResource("relay2.gif"));
    //设备屏幕截图的宽高
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("R2群控系统");
    ...
    public void bindEvent() {
        //执行特定命令
        btnCommand.addMouseListener(new R2MouseListener() {
            @Override
        ...
        //打开浏览器
        btnBrowser.addMouseListener(new R2MouseListener() {
            @Override
            public void mousePressed(MouseEvent e) {
        ...
        //群控,弹出操作面板
        btnControl.addMouseListener(new R2MouseListener() {
            @Override
            public void mousePressed(MouseEvent e) {
                if (cp == null) {
                    JFrame frame = new JFrame("操作页面");
                    cp = new ControlPage(devices, oas);
                    frame.setIconImage(icon.getImage());
        ...
        //显示屏幕
        btnConnect.addMouseListener(new R2MouseListener() {
            @Override
            public void mousePressed(MouseEvent e) {
        ...
        //返回首页
        btnHome.addMouseListener(new R2MouseListener() {
            @Override
            public void mousePressed(MouseEvent e) {
                for (OperateAndroid oa : oas) {
        ...
        //返回键
        btnBack.addMouseListener(new R2MouseListener() {
            @Override
            public void mousePressed(MouseEvent e) {
                for (OperateAndroid oa : oas) {
        ...
        //菜单键
        btnMenu.addMouseListener(new R2MouseListener() {
            @Override
            public void mousePressed(MouseEvent e) {
                for (OperateAndroid oa : oas) {
