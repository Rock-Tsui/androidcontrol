package com.relay2.ScreenCapture;
...
public class OperateAndroid {
    ...
    public void startActivity(String activityPath, String Url) {
        URI uri = URI.create(Url);
        String action = "android.intent.action.VIEW";
        Collection<String> categories = new ArrayList();
        categories.add("android.intent.category.LAUNCHER");
        try {
            device.startActivity(String.valueOf(uri), action, null, null, categories, new HashMap<String, Object>(), activityPath, 0);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void openBrower(String url) {
        startActivity("com.android.browser/com.android.browser.BrowserActivity", url);
    }
    ...
    public void openBrower() {
        startActivity("com.android.browser/com.android.browser.BrowserActivity");
    }
